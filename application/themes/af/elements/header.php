        ...
        <div role="navigation" class="navbar navbar-default navbar-fixed-top col-md-12">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="/~anchorj6/af/" class="navbar-brand"><img class="full-width" alt="AnchorFree" src="<?php echo $src = $imageF->getCollectionPath();?>../application/files/images/logo_anchorfree@2x.png"></a>
                </div><!--.navbar-header -->
