        ...
        <div role="navigation" class="navbar navbar-default navbar-fixed-top col-md-12">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="/~anchorj6/af/" class="navbar-brand"><img class="full-width" alt="AnchorFree" src="<?php echo $URL = BASE_URL. $this->url($this->getCollectionObject()->cPath)?>/tools/required/files/view?fID=78"></a>
                </div><!--.navbar-header -->
